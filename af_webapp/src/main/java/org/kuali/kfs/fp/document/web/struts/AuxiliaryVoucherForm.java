...
/**
 * Struts form so <code>{@link AuxiliaryVoucherDocument}</code> can be accessed
 * and modified through UI.
 */
public class AuxiliaryVoucherForm extends VoucherForm {
    ...
    /**
     * Gets today's date and then sets the day of the month as 15th,
     * irrespective of the current day of the month
     *
    ...
    /**
     * Handles special case display rules for displaying Reversal Date at UI
     * layer
     */
    ...
    /**
     * Returns a formatted auxiliary voucher type: <Voucher Type Name>
     * (<Voucher Type Code>)
     *
     * @return
     */
    ...
    /**
     * This method generates a proper list of valid accounting periods that the
     * user can select from.
     *
     * @see
     * org.kuali.kfs.fp.document.web.struts.VoucherForm#populateAccountingPeriodListForRendering()
     */
    @Override
    ...
    /**
     * get the reversal date default day of month defined as an application
     * parameter
     */
