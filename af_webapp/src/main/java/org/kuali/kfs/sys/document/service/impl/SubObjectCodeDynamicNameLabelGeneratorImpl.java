...
public class SubObjectCodeDynamicNameLabelGeneratorImpl implements DynamicNameLabelGenerator {
    ...
    /**
     * If the subObjectCode reference on the line is refreshable, returns the
     * sub object code's name; otherwise returns null
     *
     * @see
     * org.kuali.kfs.sys.document.service.DynamicNameLabelGenerator#getDynamicNameLabelFieldName(org.kuali.kfs.sys.businessobject.AccountingLine,
     * java.lang.String)
     */
    public String getDynamicNameLabelValue(AccountingLine line, String accountingLineProperty) {
        if (line.getPostingYear() != null && !StringUtils.isBlank(line.getChartOfAccountsCode()) && !StringUtils.isBlank(line.getFinancialSubObjectCode())) {
            ...
            if (!ObjectUtils.isNull(line.getSubObjectCode())) {
                return line.getSubObjectCode().getFinancialSubObjectCodeName();
            }
        }
        return null;
    }
     ...
     *
     * @see
     * org.kuali.kfs.sys.document.service.DynamicNameLabelGenerator#getDynamicNameLabelOnBlur(org.kuali.kfs.sys.businessobject.AccountingLine,
     * java.lang.String)
     */
    ...
    /**
     * Always returns
     * accountingLineProperty+".subObjectCode.financialSubObjectCodeName"
     *
     * @see
     * org.kuali.kfs.sys.document.service.DynamicNameLabelGenerator#getDynamicNameLabelName(org.kuali.kfs.sys.businessobject.AccountingLine,
     * java.lang.String)
     */
