...
public class PropertyLoadingFactoryBean implements FactoryBean<Properties> {
    ...
    public static String getBaseProperty(String propertyName) {
        loadBaseProperties();
        String propValue = BASE_PROPERTIES.getProperty(propertyName);
        return propValue;
    }
    ...
    protected static List<String> getBaseListProperty(String propertyName) {
        ...
        String propertyVal = BASE_PROPERTIES.getProperty(propertyName);
        List<String> mylist = null;
        try {
            mylist = Arrays.asList(propertyVal.split(","));
    ...
    protected static void loadBaseProperties() {
        if (BASE_PROPERTIES.isEmpty()) {
            ...
            // loading additional properties file in exists
    ...
    /**
     * Loads properties from an external file. Also merges in all System
     * properties
     *
