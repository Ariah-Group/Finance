...
public class AccountingLineGroupTag extends TagSupport {
    ...
    /**
     * Automagically generates teh name of the collection item property from the
     * collection property by taking any extra "s" off the end. Note: I never
     * claimed this method was smart. You'd be surprised at how often it'll
     * work, though.
     *
     * @param collectionName the collection name to generate the collection item
     * name from
    ...
    /**
     * If our parent isn't AccountingLinesTag, then we should render all the
     * group
     *
    ...
    /**
     * Creates a List of renderable elements, with all rendering transformations
     * accomplished, to be rendered
     *
     * @param groupDefinition the data dictionary definition of the accounting
     * line group this line is in
     * @param accountingLine the accounting line itself
     * @param newLine true if the line is new and not added yet to the document,
     * false otherwise
    ...
    /**
     * If it is determined that removing the first row (presumably a header row)
     * is necessary, removes it
     *
    ...
    /**
     * Looks through the top row. If there's any fields in the top row, it
     * quietly fails; it also won't remove the top row if that's the only row
     * there is
     *
    ...
    /**
     * @return the collection of accounting lines that this tag is supposed to
     * render
     */
    ...
    /**
     * @return a List of accounting line table rows to be rendered for all the
     * accounting lines available for rendering within the group
     */
    ...
    /**
     * Determines if the error map contains any errors which exist on the
     * currently rendered accounting line
     *
     * @param accountingLinePropertyName the property name of the accounting
     * line
     ...
     *
     * @param groupDefinition the data dictionary definition of the group this
     * line is a part of
     * @param accountingDocument the accounting document the line is or will
     * someday live on
     * @param accountingLine the accounting line to render
     * @param currentUser the currently logged in user
     * @param count the count of this line within the collection represented by
     * the group; null if this is a new line for the group
