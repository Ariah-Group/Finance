        ...
        try {
            ...
            for (Entry<String, String> entry : attributeValueMap.entrySet()) {
                try {
                    ...
                    // KULLAB-408
                    GlobalVariables.getMessageMap().putError(KFSConstants.ACCOUNTING_LINE_ERRORS, ERROR_INVALID_PROPERTY_VALUE, entry.getValue(), entry.getKey(), accountingLineAsString + "  : Line Number " + lineNo.toString());
