...
/**
 * A renderable element that renders child elements within a div that can be
 * hidden or displayed
 */
public class HideShowBlock implements RenderableElement {
     ...
     *
     * @see
     * org.kuali.kfs.sys.document.web.RenderableElement#appendFields(java.util.List)
     *
     * KRAD Conversion: Customization of adding the fields - No use of data
     * dictionary
     */
    ...
    /**
     * Checks if all of the child rows are empty or not; if one isn't empty,
     * then this isn't empty
     *
    ...
    /**
     * Checks if all the child rows are hidden; if so, then no point in showing
     * this...
     *
