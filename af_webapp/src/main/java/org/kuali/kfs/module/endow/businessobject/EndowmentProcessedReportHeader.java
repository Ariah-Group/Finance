...
public class EndowmentProcessedReportHeader extends TransientBusinessObjectBase {
     ...
     * @param columnHeading1 The columnHeading1 to set.
     */
     ...
     * @param columnHeading2 The columnHeading2 to set.
     */
     ...
     * @param columnHeading3 The columnHeading3 to set.
     */
     ...
     * @param columnHeading4 The columnHeading4 to set.
     */
     ...
     * @param columnHeading8 The columnHeading8 to set.
     */
