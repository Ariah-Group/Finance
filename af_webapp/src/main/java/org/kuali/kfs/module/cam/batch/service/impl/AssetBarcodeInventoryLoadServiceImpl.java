...
/**
 * Implementation of the AssetBarcodeInventoryLoadService interface. Handles
 * loading, parsing, and storing of incoming barcode inventory files.
 */
public class AssetBarcodeInventoryLoadServiceImpl implements AssetBarcodeInventoryLoadService {
    ...
    /**
     * Determines whether or not the BCIE document has all its records corrected
     * or deleted
     *
     * @param document
     * @return boolean
    ...
    /**
     * @see
     * org.kuali.kfs.module.cam.batch.service.AssetBarcodeInventoryLoadService#isCurrentUserInitiator(org.kuali.rice.krad.document.Document)
     */
    ...
    /**
     * This method removes the *.done files. If not deleted, then the program
     * will display the name of the file in a puldown menu with a label of ready
     * for process.
     *
     * @param file
     */
    ...
    /**
     * This method invokes the rules in order to validate each records of the
     * barcode file and invokes the method that updates the asset table with the
     * records that passes the rules validation
     *
    ...
    /**
     * This method updates the asset information particularly the building code,
     * bulding room, building subrool, campus code, and condition code
     *
    ...
    /**
     * This method creates a transaction document with the invalid barcode
     * inventory records
     *
     * @param barcodeInventoryErrorDetails
